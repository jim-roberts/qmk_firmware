 ...
 *
  *  Build :
  *     qmk compile -kb  mechwild/mercutio -km jimr
  *  Clean :
  *     qmk compile -kb  mechwild/mercutio -km clean
  *
  *  Flashing:
  *
  *  		1. Hold BOOT
  ...
  *  		3. Release BOOT *
  *  		4. QMK toolbox: Select Atmega 328P. Choose hex and Flash.
  *  		5. press and release RESET
  *
  *  		* NOTE: Sometimes Windows 10 OS will behave as if the ALT key is being held down
  *  	    Press and Release RIGHT ALT key a few times to "fix".
  *
  *  	    If a switch starts producing odd chars not as defined in the keymap, a "Clear EEPROM" thru QMk Toolbox may be needed.
  *
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_all(
    ...
    KC_CAPS,          KC_F11, KC_F12, KC_F13, KC_F14, KC_F15, KC_F16, KC_F17, KC_F18, KC_F19, KC_TRNS, KC_TRNS,
